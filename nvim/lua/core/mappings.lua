...
M.general = {
	...
	n = {
		...
		["<C-n>"] = { "<cmd>:b#<CR>", "Go to previous buffer", opts = { noremap = true, silent = true } },
	},
		...
		["<leader>fF"] = {
			function()
				require("telescope.builtin").find_files({
					no_ignore = true,
					hidden = true,
					file_ignore_patterns = {}, -- убираем игнор
				})
			end,
			"Find all files",
		},
			...
			function()
				require("telescope.builtin").live_grep({
					additional_args = function(_)
						return { "--hidden", "--no-ignore", "-L" } -- follow symlinks
					end,
					file_ignore_patterns = {}, -- убираем игнор .git
				})
			end,
			"Live grep (all files, hidden, no-ignore, follow)",
		},
		["<Tab>"] = {
			function()
